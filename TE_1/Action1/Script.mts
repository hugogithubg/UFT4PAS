...
TeWindow("TeWindow").TeScreen("Si").TeField("Password").SetSecure "6037deac73243dbbeff300e45d20119a" @@ hightlight id_;_826_;_script infofile_;_ZIP::ssf2.xml_;_
...
TeWindow("TeWindow").InsightObject("InsightObject_2").Click @@ hightlight id_;_8_;_script infofile_;_ZIP::ssf17.xml_;_
TeWindow("TeWindow").InsightObject("InsightObject_3").Click @@ hightlight id_;_16_;_script infofile_;_ZIP::ssf18.xml_;_
TeWindow("TeWindow").InsightObject("InsightObject_4").Click @@ hightlight id_;_22_;_script infofile_;_ZIP::ssf19.xml_;_
TeWindow("TeWindow").InsightObject("InsightObject_5").Click @@ hightlight id_;_26_;_script infofile_;_ZIP::ssf20.xml_;_
